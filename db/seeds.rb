...
i3g = Item.create(name: "Donut", category: "Dessert", note: "Chocolate-glazed", date_sell_by: nil, date_expires: DateTime.new(2018,10,1), grams: 95)
i4g = Item.create(name: "Donut", category: "Dessert", note: "Maple-glazed", date_sell_by: nil, date_expires: DateTime.new(2018,10,1), grams: 95)
i5g = Item.create(name: "Donut", category: "Dessert", note: "Cinnamon-sugar", date_sell_by: nil, date_expires: DateTime.new(2018,10,1), grams: 90)
...
u1a.fridges[1].items << i1g << i2g << i3g << i4g 
