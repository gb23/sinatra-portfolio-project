...
spacex = Organzation.create(name: "SpaceX", about: 
<<-text
...
blue_origin.rockets.first << [event_bo1, event_bo2]
...
blue_origin.rockets.last << [event_bo3, event_bo4]
